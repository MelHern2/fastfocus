...
export function useNotifications() {
    ...
    const markAllAsRead = async () => {
        ...
        const updatePromises = unreadNotifications.map(notification => updateDocument('notifications', notification.id, { isRead: true }));
        try {
    ...
    const deleteAllRead = async () => {
        ...
        const deletePromises = readNotifications.map(notification => deleteDocument('notifications', notification.id));
        try {
    ...
    const createReplyNotification = async (parentCommentAuthorId, parentCommentAuthorName, parentCommentAuthorEmail, commentId, parentCommentId, entryId, entryTitle, replyContent) => {
        if (!user.value) {
            throw new Error('Usuario no autenticado');
        }
        const notificationData = {
    ...
    const createLikeNotification = async (commentAuthorId, commentAuthorName, commentAuthorEmail, commentId, entryId, entryTitle) => {
        if (!user.value) {
            throw new Error('Usuario no autenticado');
        }
        const notificationData = {
    ...
    const createDislikeNotification = async (commentAuthorId, commentAuthorName, commentAuthorEmail, commentId, entryId, entryTitle) => {
        if (!user.value) {
            throw new Error('Usuario no autenticado');
        }
        const notificationData = {
